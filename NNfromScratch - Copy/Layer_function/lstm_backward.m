function gradients = lstm_backward(dy, da, dc, caches)
...
%                         dbo -- Gradient w.r.t. biases of the save gate, of shape (n_a, 1)
    ...
    [caches, x] = caches{:};
    [a1, c1, a0, c0, f1, i1, cc1, o1, x1, Wf, bf, Wi, bi, Wc, bc, Wo, bo, Wy, by] = caches{1}{:};
    ...
    for t = T_x:-1:1
        ...
        gradients = lstm_cell_backward(dy(:,:,t) + dy_prevt,da_prevt, dc_prevt, caches{t});
