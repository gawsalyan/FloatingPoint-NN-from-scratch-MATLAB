...
CNN_1 = convolutionLayer_Siva(30,5,15,'cnn_1');
LSTM_1 = lstmLayer_Siva(20,1,1,'lstm_1');
...
CNN = convolutionLayer_Siva(10,1,5,'cnn_1');
FL = fullyConnectedLayer_Siva(10,'mlp1');
MLclass = multiClassLayer_Siva(2,'class'); 
classnet = classnetSiva(concat, CNN, MLclass);
