classdef transfernetSiva
    ...
    methods       
      function netSiva = transfernetSiva(options, multinetSiva, partNet2, classnet)
           netSiva.no_ofNETS = nargin-1;
           netSiva.no_ofLayer = multinetSiva.no_ofLayer + partNet2.no_ofLayer + classnet.no_ofLayer;
           
            %multinetSiva = multinetSiva.initNet(multinetSiva,options);
            partNet2 = partNet2.initNet(partNet2,options);
            classnet = classnet.initNet(classnet,multinetSiva,partNet2,options);
           
           netSiva.Nets = {multinetSiva,partNet2,classnet};              
      end   
    end
    ...
    methods(Static)
       ...
       function netSiva = training(netSiva, X0, X1,X2,Y, options)
           figure();
           startSpot = 0;
           step = 0.1;
           costX = 0;
           ...
           costprev = 0;
            for i = 1:options('max_Epochs')    
                ...
                A = predictTransfernetClasses(netSiva, X0, X1, X2);
                [~,predictions] = max(A);
                [~,labels] = max(Y);
                ...
                figure(2);
                montage({netSiva.Nets{1, 1}.Nets{1, 1}.Layers{1,2}.Wf, netSiva.Nets{1, 1}.Nets{1, 1}.Layers{1,2}.Wi,...
                            netSiva.Nets{1, 1}.Nets{1, 1}.Layers{1,2}.Wc, netSiva.Nets{1, 1}.Nets{1, 1}.Layers{1,2}.Wo, ...
                            netSiva.Nets{1, 1}.Nets{1, 1}.Layers{1,2}.Wy, netSiva.Nets{1, 1}.Nets{1, 2}.Layers{1,2}.W, ...
                            netSiva.Nets{1, 1}.Nets{1, 3}.Layers{1,2}.W, netSiva.Nets{1, 1}.Nets{1, 3}.Layers{1,3}.W,...
                            netSiva.Nets{1, 2}.Layers{1,2}.W,netSiva.Nets{1, 2}.Layers{1,5}.W, netSiva.Nets{1, 3}.Layers{1,2}.W...
                            });
