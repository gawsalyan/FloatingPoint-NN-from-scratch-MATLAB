classdef convolutionLayer_Siva
    ...
    methods
      ...
      function obj = convolutionLayer_Siva(filterSize,numFilters,stride,name)
    ...
    methods(Static)
      ...
      function obj = initLayer(obj, in, options)        
          ...
          obj.OutputSize = (floor((obj.InputSize - obj.FilterSize)/obj.Stride) + 1)*obj.NumFilters ;
      end
